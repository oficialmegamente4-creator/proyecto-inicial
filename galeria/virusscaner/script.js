...
async function scanURL() {
    ...
    try {
        showLoading("Submitting URL for sacaning...");
...
async function scanfile() {
    ...
    if (file.size > 32 * 1024 * 1024) return showError("File size execeds 32MB limit.");
...
function showFormattedResult(data) {
    ...
    const categories = {
        ...
        suspicious: { color: 'suspicious', label: 'Suspicius' },
    ...
    updateResult(`
        ...
        <div class="scan-stats"> 
            <p><strong>Verdict:</strong> <span class="${verdictClass}"></span></p>
...
function showFullReport(reportData) {
    ...
    getElement("fullReportContent").innerHTML = `
        ...
        ${results ? `
            ...
            ` : `<p>No detailedresultsavailable! </p>`}
    `;
